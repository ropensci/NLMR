...
```{r dependson='nlmr_bestiary', echo=FALSE, message=FALSE, results='hide', fig.width = 20, fig.height=20, dpi = 300, fig.align='center'}
library(NLMR)
library(ggplot2)
library(viridis)
library(lemon)
...
```{r dependson='nlmr_bestiary', echo=FALSE, message=FALSE, results='hide', fig.width = 15, fig.height=12, dpi = 300, fig.align='center'}
library(NLMR)
library(ggplot2)
library(viridis)
library(lemon)
