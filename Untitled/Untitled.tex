...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={nlmR: A collection of algorithms for simulating neutral landscape models with R},
            colorlinks=true,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{nlmR: A collection of algorithms for simulating neutral landscape models
with R}
