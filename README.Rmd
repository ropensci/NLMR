...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/marcosci/NLMR?branch=master&svg=true)](https://ci.appveyor.com/project/marcosci/NLMR)
