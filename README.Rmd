...
library(patchwork)
library(ggplot2)
landscapetools::util_plot(random_cluster, discrete = TRUE, xlab = NULL, ylab = NULL) + guides(fill = FALSE)  + theme(axis.title  = element_blank(),
          axis.ticks  = element_blank(), 
          axis.text   = element_blank(),
          panel.grid  = element_blank(),
          axis.line   = element_blank())  +
landscapetools::util_plot(random_curdling, discrete = TRUE, xlab = NULL, ylab = NULL) + guides(fill = FALSE) + theme(axis.title  = element_blank(),
          axis.ticks  = element_blank(), 
          axis.text   = element_blank(),
          panel.grid  = element_blank(),
          axis.line   = element_blank()) +
landscapetools::util_plot(midpoint_displacememt, discrete = FALSE, xlab = NULL, ylab = NULL) + theme(axis.title  = element_blank(),
          axis.ticks  = element_blank(), 
          axis.text   = element_blank(),
          panel.grid  = element_blank(),
