...
test_that("nlm_mosaictess behaves like it should", {
  expect_s4_class(mosaictess, "SpatRaster")
})


test_that("nlm_mosaictess produces the right number of rows", {
  expect_equal(terra::nrow(mosaictess), 30)
})

test_that("nlm_mosaictess produces the right number of columns", {
